...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "রবিন") || (event.body.toLowerCase() == "Robin bai") || (event.body.toLowerCase() == "@FMZ ROBIN") || (event.body.toLowerCase() == "রবিন")) {
     return api.sendMessage("উনি এখন মিমি ভাবির সাথে বিজি আছে কি বলবেন আমাকে বলতে পারেন..!😘",threadID);
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "@মি্ঁমিঁ") || (event.body.toLowerCase() == "@Farhana Ontora ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস রবিন এর বউ এর আইড়ি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Mahiya") || (event.body.toLowerCase() == "Mahiya")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস রবিন এর GF এর নাম..!😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "Eva") || (event.body.toLowerCase() == "Eva")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস রবিন এর bon এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "@Erfan Ahmmed ") || (event.body.toLowerCase() == "সিয়াম")) {
   ...
   if ((event.body.toLowerCase() == "sadiya") || (event.body.toLowerCase() == "ex")) {
   ...
   if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😍") || (event.body.toLowerCase() == "😻") || (event.body.toLowerCase() == "❤️")) {
     return api.sendMessage("ভালোবাসা নামক আবলামী করতে চাইলে রবিন এন  ইনবক্সে চলে যা পাগল ছাগল🌚🐸🌶️🍆", threadID);
   };
